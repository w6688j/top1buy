            ...
            <div class="product_view">
                ...
                <div class="product_info" id="product_page_info">
                    ...
                    <div>
                        <div class="rbc_cold">
							<span>
								<span class="average_rating"><?= Yii::$service->page->translate->__('Average rating'); ?>
                                    :</span>
								<span class="review_star review_star_<?= round($reviw_rate_star_average) ?>"
                                      style="font-weight:bold;" itemprop="average"></span>
                    ...
                    <div class="product_info_section">
                        ...
                        <div class="addtocart">
                            <button type="button" id="js_registBtn" class="redBtn addProductToCart">
                                <em><span><i></i><?= Yii::$service->page->translate->__('直接去购物'); ?></span></em>
                            </button>
...
<script>
    ...
    $(document).ready(function () {
        $(".addProductToCart").click(function () {
            str = "<?= $url_key ?>";
            url = str.substr(0,4).toLowerCase() == "http" ? str : "http://" + str;
            window.open(url);
        });
        //$(".addProductToCart").click(function(){
        //	i = 1;
